...
// Arm & Disarm delays
#define ARM_DELAY 1     //50 // how long you need to keep rudder to max right for arming motors (units*0.02, 50=1second)
#define DISARM_DELAY 1   //25 // how long you need to keep rudder to max left for disarming motors
#define SAFETY_DELAY 1   //25 // how long you need to keep throttle to min before safety activates and does not allow sudden throttle increases
