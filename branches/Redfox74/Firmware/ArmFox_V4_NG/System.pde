...
void APM_Init() {
  ...
  */
  ...
  flightOrientation = 0; //SW_DIP1;     // DIP1 off = we are in + mode, DIP1 on = we are in x mode Fixed at +
...
//  SerBeg(SerBau);
  ...
  //{
  //  SerialUSB.println("Entering Log Read Mode...");    // This will be obsole soon due moving to CLI system
  //  Log_Read(1,1000);
  //  delay(30000);
  //}
