...
//#define SerBau  115200      // Baud setting moved close next to port selection
#define SerPri  SerialUSB.print
#define SerPrln SerialUSB.println
#define SerPriln SerialUSB.println
#define SerRea  SerialUSB.read
#define SerAva  SerialUSB.available
#define SerRea  SerialUSB.read
#define SerFlu  SerialUSB.flush
#define SerBeg  SerialUSB.begin
#define SerP    SerialUSB.printf_P
